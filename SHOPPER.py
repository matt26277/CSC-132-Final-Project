...
class MainGUI (Frame):
    ...
    def setupGUI (self):
        ...
        myFont = tkFont.Font (size = 80)
        button = Button (self, bg = "white", text = "SHOPPER", \
                        borderwidth = 0, highlightthickness = 0,\
                        activebackground = "white", command = lambda:\
                        self.process ("title"))
        button ["font"] = myFont
        ...
        button.grid (row = 0, column = 3, columnspan = 4, sticky = N+S+E+W)
        ...
        button = Button (self, bg = "white", image = img, \
                        ...
                        activebackground = "white", height = 100, width = 100, command = lambda:\
                         self.process ("item"))
        button.image = img
        button.grid (row = 1, rowspan = 4, column = 3, columnspan = 4, sticky = N+S+E+W)
    ...
    def process (self, button):            
        ...
        if (button == "added to cart"):
            ...
            cart_list.pop()
            self.display ["text"] = "LAST ITEM REMOVED FROM CART"
...
iphone = Item (600, "Lisa", "AR", 0.5, "Used", "Apple", "White", "iPhone XR", "Phone", "iphone1.gif", "iPhone")


item_list = [final, cyber, shoes, atruck, hat, mtruck, pants, struck, iphone]
